...
mycolumn='dairy'
myheading1 = f"Wow! That's a lot of {mycolumn}! \n (California? Really? Who Knew?)"
mygraphtitle = '2011 US Agriculture Exports by State'
mycolorscale = 'ylorrd' # Note: The error message will list possible color scales. This is one of the colorscales in plot.ly
mycolorbartitle = "Millions USD"
tabtitle = 'Old McDonald'
sourceurl = 'https://plot.ly/python/choropleth-maps/'
githublink = 'https://github.com/regina-avila/dash-map-usa-agriculture'
